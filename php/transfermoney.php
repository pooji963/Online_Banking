            ...
            <div class="row">
                ...
                ?>
                    <tr style="color : black;">
                        ...
                        <td><a href="selecteduser.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn" style="background-image: linear-gradient(0deg,#c9f3fe,rgb(188 186 241));">Transact</button></a></td> 
                    </tr>
                <?php
                    }
                ?>
